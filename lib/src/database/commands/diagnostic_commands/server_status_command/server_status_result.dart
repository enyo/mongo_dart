...
class ServerStatusResult with BasicResult {
  ServerStatusResult(Map<String, Object?> document) {
    ...
    logicalSessionRecordCache = document[keyLogicalSessionRecordCache] as Map<String, dynamic>?;
    ...
    opReadConcernCounters = document[keyOpReadConcernCounters] as Map<String, dynamic>?;
    opWriteConcernCounters = document[keyOpWriteConcernCounters] as Map<String, dynamic>?;
    ...
    shardingStatistics = document[keyShardingStatistics] as Map<String, dynamic>?;
    shardedIndexConsistency = document[keyShardedIndexConsistency] as Map<String, dynamic>?;
    ...
    writeBacksQueued = document[keyWriteBacksQueued] as bool?;
    mem = document[keyMem] as Map<String, dynamic>?;
